...
| ---- | ------ | --------------- | ---------- | ----- | ------ | ----- | ------------- | -------------- | ------------ | 
| 📝 | GitcoinPassportEligibility.sol | 1 | **** | 111 | 105 | 31 | 62 | 23 | **<abbr title='TryCatch Blocks'>♻️</abbr>** |
| 📝 | **Totals** | **1** | **** | **111**  | **105** | **31** | **62** | **23** | **<abbr title='TryCatch Blocks'>♻️</abbr>** |
...
- **Comment-to-Source Ratio:** On average there are`0.6` code lines per comment (lower=better).
- **ToDo's:** `0` 
...
|-------------|--------------|
| GitcoinPassportEligibility.sol | [object Promise] |
...
||||||
| **GitcoinPassportEligibility** | Implementation | HatsEligibilityModule |||
| └ | GITCOIN_PASSPORT_DECODER | Public ❗️ |   |NO❗️ |
| └ | SCORE_CRITERION | Public ❗️ |   |NO❗️ |
| └ | <Constructor> | Public ❗️ | 🛑  | HatsModule |
