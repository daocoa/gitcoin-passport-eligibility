...
contract DeployImplementation is ScaffoldETHDeploy {
    ...
    function _log(string memory prefix) internal view {
        if (_verbose) {
            console2.log(
                string.concat(prefix, "GitcoinPassportEligibility"),
    ...
    function run() public virtual {
         ...
         */
        implementation = new GitcoinPassportEligibility{salt: SALT}(
            _version /* insert constructor args here */
        );
